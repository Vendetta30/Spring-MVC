    ...
    <div class="row">
        <div class="col-lg-6 col-lg-offset-3">
            ...
            <form method="post" class="form-horizontal">
                <div class="col-lg-6 col-lg-offset-3">
                    <fieldset>
                        <label class="text-left control-label" for="forestName">Forest Name</label>
                        <input class="pull-right form-control input-md" name="forestName" id="forestName"
                               placeholder="Enter Forest Name"/>
                        <errors name="forestName" class="error"/>
                        <br>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-lg-offset-3">
                                ...
                                <div class="pull-right">
                                    &nbsp;<a class="btn btn-info" href="<s:url value="/forest/list"/>">Forest List</a>
                                </div>
                            </div>
                        </div>
                    </fieldset>
